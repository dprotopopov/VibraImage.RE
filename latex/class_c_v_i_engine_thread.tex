...
Предоставленная реализация функции только устанавливает размер массива m\+\_\+stat равным размеру массива m\+\_\+stat родительского инстанса класса реализованных алгоритмов программы. m\+\_\+stat.\+resize(m\+\_\+p\+Base-\/$>$m\+\_\+stat.\+size()); 
...
\hline
{\em h\+X} & Сумма элементов по столбцам исходного массива. Выход. Размер массива устанавливается равным ширине изображения. \\
\hline
{\em h\+Y} & Сумма элементов по строкам исходного массива. Выход. Размер массива устанавливается равным высоте изображения. \\
\hline
